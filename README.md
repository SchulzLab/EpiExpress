...
| `provided_input`          | Path to the folder 'ProvidedInput' that holds additional files necessary for generating the input. It is available on [Zenodo](https://zenodo.org/uploads/13992024). Please do not change the file names, otherwise the scripts will crash.                                                                                                                                                                      |
