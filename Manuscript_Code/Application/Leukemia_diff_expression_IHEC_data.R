...
#saving the result:
writeLines(sig_genes_deseq_adult_real, "/path/to/data/testing_hiwas/sig_genes_real.txt")
...
writeLines(sig_genes_deseq_adult_RF, "/path/to/data/testing_hiwas/sig_genes_RF.txt")
# MA and dispersion plots
plotMA(res2)
################################################################################################################################################################################################################################################
...
writeLines(sig_genes_deseq_adult_CNN, "/path/to/data/testing_hiwas/sig_genes_CNN.txt")
# MA and dispersion plots
plotMA(res2)
################################################################################################################################################################################################################################################
...
significant_gene_names_real= readLines("/path/to/data/testing_hiwas/sig_genes_real.txt")
